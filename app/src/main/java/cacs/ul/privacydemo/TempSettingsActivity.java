...
public class TempSettingsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.temp_p_activity);
        ...
        reminderSwitch.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    TimeScheduler_Temp.setReminder(TempSettingsActivity.this, Alarm_Prof_Receiver.class, localData.get_hour(), localData.get_min());
                    ll_set_time.setAlpha(1f);
                } else {
                    Log.d(TAG, "onCheckedChanged: false");
                    TimeScheduler_Temp.cancelReminder(TempSettingsActivity.this, Alarm_Prof_Receiver.class);
                    ll_set_time.setAlpha(0.4f);
                }
